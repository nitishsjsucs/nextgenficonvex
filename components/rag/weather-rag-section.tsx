...
export function WeatherRAGSection() {
  ...
  const generateEmail = async () => {
    ...
    console.log('📧 [DEBUG] ===== WEATHER RAG SECTION EMAIL GENERATION =====');
    ...
    try {
      ...
      console.log('📧 [DEBUG] Target weatherEvent:', requestBody.target?.weatherEvent);
      ...
      console.log('📧 [DEBUG] Making API call to /api/rag/generate-weather-email');
